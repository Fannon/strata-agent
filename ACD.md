...
This hypothesis is captured in [035](.work/issues/035-enterprise-capability-scaling.md), with [primary-source research](docs/research/enterprise-capability-scaling.md). Accurate schemas may reduce onboarding work; they do not supply business semantics or establish runtime permission. 004 remains the active context-cost trajectory. No enterprise implementation or model trial is started by this concept.
